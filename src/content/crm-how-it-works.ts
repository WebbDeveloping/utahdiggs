...
export const JOURNEY_STEPS: JourneyStep[] = [
  ...
  },
  {
    ...
    owner: "Both",
    body: "The seller picks a time. That call shows up under Upcoming calls so the team can prepare and show up. After scheduling, they go to the account home to start MLS property intake.",
  ...
  },
  {
    ...
    owner: "Seller",
    body: "The long WFRMLS-style form (~20–25 minutes). When they submit, the listing moves into review — it is not live yet. Photos can be added from the account or listing afterward; the MLS needs at least 2 exterior and 3 interior photos to go live.",
...
export const ROLE_CARDS: RoleCard[] = [
  {
    ...
    responsibilities: [
      "Finish onboarding (plan, agreement, call, MLS form)",
...
export const STATUS_ITEMS: StatusItem[] = [
  {
    ...
    state: "live",
    note: "Plan, agreement, call, and full intake form",
  },
  {
