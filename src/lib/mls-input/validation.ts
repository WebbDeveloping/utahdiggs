...
export const step5Schema = z.object({
    ...
    "noAssignedParcelNumber": z.enum(["No", "Yes"] as const).optional(),
...
export const step10Schema = z.object({
    "q39-typea39": z.array(z.string()).optional(),
    ...
    "q38-zoning": z.array(z.string()).optional(),
...
export const step13Schema = z.object({
    "q207-typea207": z.enum(["Yes", "No, I have someone else"] as const, { message: "Required" }),
