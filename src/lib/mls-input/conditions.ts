...
export const MLS_CONDITION_RULES: ConditionRule[] = [
  ...
  {
    "id": "has-basement",
    "description": "Show basement type and finished fields when the property has a basement.",
    "when": {
      "field": "hasBasement",
      "equals": "Yes"
    },
