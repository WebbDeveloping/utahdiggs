...
import WeeklyShowingsChart from "@/components/account/charts/WeeklyShowingsChart";
...
type AccountShowingsListProps = {
  ...
  weekChart?: ShowingsWeekChartData | null;
};
...
export default function AccountShowingsList({
  ...
  return (
    <Stack spacing={3}>
      {weekChart ? <WeeklyShowingsChart data={weekChart} /> : null}
