        ...
        <Stack spacing={4}>
          ...
          {submitted ? (
            <Alert severity="success">
              Your MLS intake was submitted successfully. Our team will review it before
              it goes live. Reference: <strong>{submitted}</strong>
            </Alert>
          ) : null}
              ...
              <TableBody>
                {listings.length === 0 ? (
                  ...
                  listings.map((listing) => {
                    const inProgress =
                      isMlsDraft(listing) || isOnboardingListing(listing);
