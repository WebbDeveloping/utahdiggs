...
function buildBaseMlsValues(
  ...
  return {
    ...
    "q36-typea36": ["Landscaping: Full", "Mature Trees"],
    "q43-lot-facts": ["Curb & Gutter", "Sidewalks", "Terrain: Flat", "Sprinkler: Auto-full"],
    petsAllowed: "No",
    "q47-animals": [],
    "q39-typea39": ["Garage", "Basement"],
    "q35-connectedutilities": ["Gas: Connected", "Power: Connected", "Sewer: Connected"],
    "q44-water": ["Culinary"],
    "q45-telecommunications": ["Fiber", "Broadband Cable"],
